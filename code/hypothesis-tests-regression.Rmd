...
for (jj in seq_along(beta_scale)) {
...
plot(beta_scale, num_significant / num_trials,
     xlab="beta_scale", ylab="Power to reject F test null")
```
...
1. The power increases with increasing beta in a 
2.
