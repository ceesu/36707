...
```{r trim, fig.width=5, fig.height=4, echo=FALSE, message=FALSE, warning= FALSE,fig.cap="\\label{fig:trim} Distributions of important demographic variables show outliers in the raw data."}
...
We performed variable selection to exclude variables those without large effects. We included the interaction terms between diversity score and each of the hormones, which are interpretable interaction terms that we need to consider to answer the substantive questions. 
