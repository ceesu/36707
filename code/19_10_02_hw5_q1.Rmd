...
It seems validation error is lowest around 4 terms. Therefore we try to obtain the best four term model.
...
```{r}
regfit_best = regsubsets(final.performance~.^2, data = team_dat[,vars], nvmax = 4)
coef(regfit_best, 4)
coef(regfit.fwd, 4)
```
