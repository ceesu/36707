...
cv.errors=matrix(NA,10,36)
for(k in 1:10){
  # best fit on the train data
  best.fit=regsubsets(final.performance~.^2.,data=team_dat[folds!=k,],nvmax=40,method="forward")
  # performance on the test data
  for(i in 1:36){
    pred=predict(best.fit,team_dat[folds==k,],id=i)
