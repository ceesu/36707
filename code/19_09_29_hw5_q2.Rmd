...
* the plot of residuals vs. leverage shows a couple of potentially problematic outliers w
...
Whereas half.fit and cv.fit are very similar, half_cv.fit
...
cv <- crossv_kfold(filt_data)
for(split in cv){
  # get model on specific train fold
