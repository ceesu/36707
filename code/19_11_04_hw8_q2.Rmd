...
When increasing mtry, the time increases linearly and the accuracy decreases, then starts to increase past about mtry=10.
...
We see that the error decreases to around 10% when depth > 6. This suggests the minimum depth would be around 6. This is a bit larger than we might have expected based on the activity, because we expected that a tree depth of 2 would work okay.  
